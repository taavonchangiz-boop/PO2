    ...
    for (var i = 0; i < parts.length; i++) {
        ...
        if (i === 0) {
            ...
            if (adminMatch) {
                ...
                title.style.cssText = 'font-size:0.8rem; color:#FDE68A; font-weight:900; margin-bottom:0.4rem;';
                title.textContent = '👑 پیام مدیر سیستم (' + adminMatch[1] + '):';
                var date = document.createElement('div');
                date.style.cssText = 'font-size:0.7rem; color:#4A4857; margin-bottom:0.5rem;';
                ...
                userTitle.style.cssText = 'font-size:0.75rem; color:#A5B4FC; font-weight:bold; margin-bottom:0.4rem;';
